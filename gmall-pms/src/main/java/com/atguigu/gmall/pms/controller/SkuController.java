...
public class SkuController {
    ...
    public ResponseVo<List<SkuEntity>> querySkusBySpuId(@PathVariable Long sId){
        List<SkuEntity> skuEntities = skuService.list(new QueryWrapper<SkuEntity>().eq("spu_id", sId));
